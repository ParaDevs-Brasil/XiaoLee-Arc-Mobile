...
_PLATFORM_CONTEXT = (
    ...
    "agora: a Genesis Campaign (segue + retweet, 50 $XLEE), o Swap Challenge (100 $XLEE só por um swap) "
    "e a Community Builder (250 $XLEE indicando amigos). Qual te chama mais atenção?' — plain text, no "
    "bold and no *italic* wrapping a name per line either; putting a single asterisk around each item "
    "(*Genesis Campaign*, *Swap Challenge*...) is the exact same catalog problem wearing a different "
